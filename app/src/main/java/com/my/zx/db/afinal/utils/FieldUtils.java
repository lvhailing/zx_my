...
import com.my.zx.db.afinal.annotation.sqlite.ManyToOne;
import com.my.zx.db.afinal.annotation.sqlite.OneToMany;
import com.my.zx.db.afinal.annotation.sqlite.Property;
import com.my.zx.db.afinal.annotation.sqlite.Transient;
...
/**
 * @title 鐎涙顔岄幙宥勭稊瀹搞儱鍙跨猾锟?
 * @description 閹诲繗鍫?
 * @company 閹恒垻鍌ㄩ懓鍛秹缂佹粌浼愭担婊冾吇(www.tsz.net)
...
public class FieldUtils {
	...
	private static boolean isISStart(String fieldName) {
		if (fieldName == null || fieldName.trim().length() == 0)
			return false;
		// is瀵拷婢惰揪绱濋獮鏈电瑬is娑斿鎮楃粭顑跨娑擃亜鐡уВ宥嗘Ц婢堆冨晸 濮ｆ柨顩? isAdmin
	...
	/**
	 * 濡拷濞达拷 鐎涙顔岄弰顖氭儊瀹歌尙绮＄悮顐ｇ垼濞夈劋璐? 闂堢偞鏆熼幑顔肩氨鐎涙顔?
	 *
	 * @param f
	 * @return
	 */
